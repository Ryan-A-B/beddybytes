...
export const Head: HeadFC = () => (
    <SEOHead
        ...
        description="Record baby monitor moments to your device instantly. BeddyBytes saves recordings locally to your downloads folder with no cloud recording or storage."
